...
require('./search.scss.js');
var wiki = require('../../../assets/images/wiki.png.js');
...
var _jsxFileName = "/Users/yuanjiexuan/Desktop/bate/project-web/doublekit-wiki-ui/doublekit-wiki-ui/src/modules/search/components/searchResult.js";
...
var SearchResult = function SearchResult(props) {
  ...
  var getSearchSore = searchStore.getSearchSore,
      sortList = searchStore.sortList,
      searchForPage = searchStore.searchForPage,
      keyword = searchStore.keyword,
      searchCondition = searchStore.searchCondition,
      setKeyWord = searchStore.setKeyWord,
      searchList = searchStore.searchList,
      getSearch = searchStore.getSearch;
  var setWikiId = wikiDetailStore.setWikiId;

  var _useState = React.useState(),
      _useState2 = _slicedToArray(_useState, 2),
      lastRecord = _useState2[0],
      setLastRecord = _useState2[1];
  ...
  React.useEffect(function () {
    ...
    return;
  }, [sortList, keyword]); // 输入中

  var _useState7 = React.useState("hidden"),
      _useState8 = _slicedToArray(_useState7, 2),
      showRes = _useState8[0],
  ...
  var changeTab = function changeTab(activeKey) {
    searchForPage({
      currentPage: 1,
      index: activeKey
    }).then(function (res) {
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            ...
            case 4:
              setShow("hidden"); // location.reload();
  ...
  var toWorkItem = /*#__PURE__*/function () {
    ...
    return function toWorkItem(_x2) {
  ...
  var hiddenBox = function hiddenBox() {
    setShow("hidden");
  };
  ...
  return /*#__PURE__*/React__default["default"].createElement(_Row__default["default"], {
  ...
  }, "\u641C\u7D22")), /*#__PURE__*/React__default["default"].createElement("div", {
    className: "show-box ".concat(searchList.length !== 0 && showRes === "show" ? null : "hidden-box"),
    __source: {
      fileName: _jsxFileName,
      lineNumber: 111,
      columnNumber: 25
    }
  }, searchList && searchList.map(function (item, index) {
    ...
    }(), item.dataList && item.dataList.map(function (toItem) {
      return /*#__PURE__*/React__default["default"].createElement("div", {
        className: "item-box",
        key: toItem.id,
        __source: {
    ...
    return /*#__PURE__*/React__default["default"].createElement(TabPane, {
      tab: "".concat(table(item.index), "(").concat(item.totalRecord, ")"),
      key: item.index,
      __source: {
        fileName: _jsxFileName,
        lineNumber: 160,
    ...
    }, itemList && itemList.map(function (itemWork) {
      return /*#__PURE__*/React__default["default"].createElement("div", {
        className: "wiki-box",
        key: itemWork.id,
        __source: {
        ...
        switch (item.index) {
          case "wiki":
            return /*#__PURE__*/React__default["default"].createElement("div", {
              className: "wiki-contant",
              onClick: function onClick() {
                return toWiki(itemWork.id);
              },
              __source: {
                fileName: _jsxFileName,
                lineNumber: 169,
            ...
            }, itemWork.wikiName), /*#__PURE__*/React__default["default"].createElement("div", {
              __source: {
                fileName: _jsxFileName,
                lineNumber: 171,
                columnNumber: 69
              ...
              className: "wiki-item-name",
              __source: {
                fileName: _jsxFileName,
                lineNumber: 172,
                columnNumber: 73
              }
            }, "\u77E5\u8BC6\u5E93ID:"), itemWork.id), /*#__PURE__*/React__default["default"].createElement("div", {
              __source: {
                fileName: _jsxFileName,
                lineNumber: 174,
                columnNumber: 69
            ...
            }, "\u77E5\u8BC6\u5E93\u8BE6\u60C5:  "), "\u534F\u540C\u529E\u516C\u77E5\u8BC6\u5E93\u534F\u540C\u529E\u516C\u77E5\u8BC6\u5E93\u534F\u540C\u529E\u516C\u77E5\u8BC6\u5E93\u534F\u540C\u529E\u516C\u77E5\u8BC6\u5E93\u534F\u540C\u529E\u516C\u77E5\u8BC6\u5E93"));

          case "WorkItem":
            return /*#__PURE__*/React__default["default"].createElement("div", {
              className: "wiki-contant",
              onClick: function onClick() {
                return toWorkItem(itemWork.id);
              },
              __source: {
                fileName: _jsxFileName,
                lineNumber: 180,
            ...
            }, itemWork.title), /*#__PURE__*/React__default["default"].createElement("div", {
              __source: {
                fileName: _jsxFileName,
                lineNumber: 182,
                columnNumber: 69
            ...
            }, "\u4E8B\u9879ID:"), itemWork.id), /*#__PURE__*/React__default["default"].createElement("div", {
              __source: {
                fileName: _jsxFileName,
                lineNumber: 185,
                columnNumber: 69
            ...
            }, "\u4E8B\u9879\u8BE6\u60C5:  "), "\u534F\u540C\u529E\u516C\u77E5\u8BC6\u5E93\u534F\u540C\u529E\u516C\u77E5\u8BC6\u5E93\u534F\u540C\u529E\u516C\u77E5\u8BC6\u5E93\u534F\u540C\u529E\u516C\u77E5\u8BC6\u5E93\u534F\u540C\u529E\u516C\u77E5\u8BC6\u5E93"));
        }
      }()));
    }));
  })), /*#__PURE__*/React__default["default"].createElement(_Pagination__default["default"], _extends({
    defaultCurrent: 1
  }, searchCondition, {
    onChange: changePage,
    __source: {
...
var searchResult = mobxReact.inject("searchStore", "wikiDetailStore")(mobxReact.observer(SearchResult));
