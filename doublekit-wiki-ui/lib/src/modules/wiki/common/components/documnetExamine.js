...
var DocumentExamine = function DocumentExamine(props) {
  ...
  }, "\u7C7B\u578B\uFF1A", docDetail.type === "doc" ? "文档" : "目录")), /*#__PURE__*/React__default["default"].createElement(doublekitSlateUi.PreviewEditor, {
    value: value,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 112,
...
var DocumentExamine$1 = mobxReact.inject("wikiCommon")(mobxReact.observer(DocumentExamine));
