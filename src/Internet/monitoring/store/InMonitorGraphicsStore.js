...
export class InMonitorGraphicsStore {
    ...
    //网络告警时间
    @observable internetAlarmDate = null;

    @action
    setInternetAlarmDate = (value) => {
        this.internetAlarmDate = value
    }
...
const monitorLayoutStore = new InMonitorGraphicsStore();
