...
import {Button, Col, Input, Popconfirm, Row, Table, Tag} from "antd";
import {SearchOutlined} from "@ant-design/icons";
import "./Databases.scss"
const TestMonitor = (props) => {
    ...
    function hrefAddDatabases() {
        if (location.pathname !== '/databases/addDBMonitor') {
            props.history.push('/databases/addDBMonitor');
        }
    }
            ...
            <Col sm={24} md={24} lg={{span: 24}} xl={{span: "22", offset: "1"}} xxl={{span: "18", offset: "3"}}>
                ...
                <div className="db-body">
                    <div className="db-title">
                        <div className="db-title-text">监控项配置</div>
                        <div className="db-title-add-button" onClick={() => hrefAddDatabases()}>新建监控项</div>
                    </div>
